...
public class PhotoMaker : MonoBehaviour
{
	...
	void Update()
    {
        ...
        if (PlayerStatusManager.CurrentInterStatus == InteractionStatus.None && tutorialInfo.IsTutorialEnd)
        {
        ...
        else if(PlayerStatusManager.CurrentInterStatus == InteractionStatus.Photo)
        {
