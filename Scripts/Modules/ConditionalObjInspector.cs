...
{
	private enum InspectorPlacement { OnRight, OnLeft, OnBottom, OnObject }
	private enum InspectorCondition { OnHover, OnObservation }
	...
	protected override void OnMouseHover()
	{
		...
		if (mouseHovableStatus != PlayerStatusManager.CurrentInterStatus) return;
